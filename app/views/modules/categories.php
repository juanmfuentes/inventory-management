                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header d-flex justify-content-end">
                            ...
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalAddCategory">
                                <i class="fas fa-plus-circle pr-2"></i> Nueva categoría
                            </button>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group d-flex">
                                                    <button type="button" class="btn btn-sm btn-warning btnEditCategory" idCategory="' . $value["id"] . '" 
                                                data-toggle="modal" data-target="#modalEditCategory" style="color:white;">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <button type="button" class="btn btn-sm btn-danger btnDeleteCategory" idCategory="' . $value["id"] . '">
            ...
            <form role="form" method="post">
                ...
                <div class="modal-body p-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="categoryName" name="categoryName" placeholder="Nombre de la categoría" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label font-weight-normal">Descripción</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" rows="3" id="categoryDescription" name="categoryDescription" placeholder="Descripción de la categoría"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body p-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input class="form-control" id="editCategoryName" name="editCategoryName" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label font-weight-normal">Descripción</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" rows="3" id="editCategoryDescription" name="editCategoryDescription"></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
