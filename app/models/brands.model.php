...
class BrandsModel
{
    ...
    static public function mdlNewBrand($table, $data)
    {
    ...
    static public function mdlShowBrands($table, $item, $value)
    {
        if ($item != null) {
    ...
    static public function mdlEditBrand($table, $data)
    {
    ...
    static public function mdlDeleteBrand($table, $data)
    {
