...
class LocationsModel
{
    ...
    static public function mdlNewLocation($table, $data)
    {
    ...
    static public function mdlShowLocations($table, $item, $value)
    {
        if ($item != null) {
    ...
    static public function mdlEditLocation($table, $data)
    {
    ...
    static public function mdlDeleteLocation($table, $data)
    {
